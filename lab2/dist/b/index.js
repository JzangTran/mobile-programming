...
// Ex14
const ex14 = async (num) => {
    return new Promise((resolve) => setTimeout(() => resolve(num * 3), 1000));
};
// Ex15
const ex15 = async () => {
...
// Ex20
const ex20 = async () => {
    const timeout = new Promise((_, reject) => setTimeout(() => reject(new Error('Timeout exceeded')), 2000));
